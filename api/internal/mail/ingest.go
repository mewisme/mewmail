...
func (h *IngestHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	id, previewOTK, keepOTK, err := h.DB.InsertEmail(r.Context(), email)
	if err != nil {
	...
	if h.Webhook != nil {
		h.Webhook.EmailReceived(id, email.MailFrom, email.RcptTo, email.Subject, email.MessageID, previewOTK, keepOTK)
	}
